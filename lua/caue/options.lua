...
vim.opt.writebackup = false                     -- if a file is being edited by another program (or was written to file while editing witha another program), it is not allowed to be edited
...
vim.opt.scrolloff = 8                           -- offsets the currently selected line by 8 vertically
vim.opt.sidescrolloff = 8                       -- offsets the currently selected line by 8 horizontally
